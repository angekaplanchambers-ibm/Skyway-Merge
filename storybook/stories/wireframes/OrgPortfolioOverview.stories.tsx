...
function OrgPortfolioOverview({
  ...
  const [activePortfolioTab, setActivePortfolioTab] = useState<'activity' | 'automation' | 'monitoring'>('activity');
            ...
            {activePortfolioTab === 'monitoring' ? (
              <>
                ...
                <div style={{ padding: '0 10px 10px' }}>
                  <div style={{ ...TILE, marginTop: 8, overflow: 'hidden' }}>
                    <div
                      style={{
                        display: 'grid',
                        gap: 2,
                    ...
                    >
                      <span style={{ fontSize: 12, fontWeight: 700, color: TOK.textPrimary, textTransform: 'uppercase', letterSpacing: '0.03em' }}>
