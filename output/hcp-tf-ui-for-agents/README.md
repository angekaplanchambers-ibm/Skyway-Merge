...
|------|-------|-------------|
| [workspaces-list.md](pages/workspaces-list.md) | `/app/{org}/workspaces` | Workspace listing with filters |
| [workspace-overview.md](pages/workspace-overview.md) | `/app/{org}/workspaces/{ws}` | Workspace dashboard |
| [workspace-runs.md](pages/workspace-runs.md) | `/app/{org}/workspaces/{ws}/runs` | Run history |
| [workspace-run-detail.md](pages/workspace-run-detail.md) | `/app/{org}/workspaces/{ws}/runs/{run}` | Individual run details |
| [workspace-states.md](pages/workspace-states.md) | `/app/{org}/workspaces/{ws}/states` | State management |
| [workspace-variables.md](pages/workspace-variables.md) | `/app/{org}/workspaces/{ws}/variables` | Variable configuration |
| [workspace-settings.md](pages/workspace-settings.md) | `/app/{org}/workspaces/{ws}/settings` | Workspace settings |
| [workspace-health.md](pages/workspace-health.md) | `/app/{org}/workspaces/{ws}/health/drift` | Drift detection & health |
| [workspace-search.md](pages/workspace-search.md) | `/app/{org}/workspaces/{ws}/search` | Search & import |
| [workspace-change-requests.md](pages/workspace-change-requests.md) | `/app/{org}/workspaces/{ws}/change-requests` | Change request workflows |

### Organization
| File | Route | Description |
|------|-------|-------------|
| [organizations-list.md](pages/organizations-list.md) | `/app/organizations` | Organization selection |
| [projects-list.md](pages/projects-list.md) | `/app/{org}/projects` | Project management |
| [project-detail.md](pages/project-detail.md) | `/app/{org}/projects/{project}` | Project details |
| [stacks-list.md](pages/stacks-list.md) | `/app/{org}/stacks` | Stacks management |
| [org-settings.md](pages/org-settings.md) | `/app/{org}/settings` | Organization settings |

### Registry
| File | Route | Description |
|------|-------|-------------|
| [registry-modules.md](pages/registry-modules.md) | `/app/{org}/registry/modules` | Module registry |
| [registry-providers.md](pages/registry-providers.md) | `/app/{org}/registry/providers` | Provider registry |
| [registry-design.md](pages/registry-design.md) | `/app/{org}/registry/design` | Configuration designer |
| [registry-public-namespaces.md](pages/registry-public-namespaces.md) | `/app/{org}/registry/public-namespaces` | Public namespace browser |

### Analytics
| File | Route | Description |
|------|-------|-------------|
| [explorer.md](pages/explorer.md) | `/app/{org}/explorer` | Data explorer & queries |
| [usage.md](pages/usage.md) | `/app/{org}/usage` | Usage statistics |
...
**Single Page Context:**
1. Copy `pages/_index.md` (overview) into your LLM for navigation structure
2. Copy the specific page file you need from `pages/` (e.g., `pages/workspace-overview.md`)
3. Ask questions about layouts, zones, and clickable elements

**Multiple Pages:**
1. Start with `quick-reference.md` for orientation
2. Load relevant page files from `pages/` for your task (e.g., all `pages/workspace-*.md` files)
